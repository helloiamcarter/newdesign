...
echo $includes[0]; ?>
	...
	<div id="list">
        <h1>General Dermatology</h1>
			<div class="row">
				<a href="acne.php">
					<img src="images/acne.jpg" alt="acne" class="first" />
				</a>
				<a href="birthmarks.php">
					<img src="images/birthmarks.jpg" alt="birthmarks" />
				</a>
				<a href="blisters.php">
					<img src="images/blister.jpg" alt="blisters" />
				</a>
			...
			<div class="row">
				<a href="eczema.php">
					<img src="images/eczema.jpg" alt="eczema" class="first" />
				</a>
				<a href="hidradenitis-suppurativa.php">
					<img src="images/hidradentitis-suppurativa.jpg" alt="hidradenitis suppurativa" />
				</a>
				<a href="hives.php">
					<img src="images/hives.jpg" alt="hives" />
				</a>
				<a href="keratosis-pilaris.php">
					<img src="images/keratosispilaris.jpg" alt="keratosis pilaris" />
				</a>
			</div>
			<div class="text-row">
				<a href="eczema.php" class="first">Eczema</a>
				<a href="hidradenitis-suppurativa.php">Hidradenitis Suppurativa</a>
				<a href="hives.php">Hives</a>
				<a href="keratosis-pilaris.php">Keratosis Pilaris</a>
			</div>			
			<div class="row">
				<a href="lichen-simplex-chronicus.php">
					<img src="images/lichen-simplex-chronicus.jpg" alt="lichen simplex chronicus" class="first" />
				</a>
				<a href="lice.php">
					<img src="images/louse.jpg" alt="lice" />
				</a>
				<a href="nail-fungus.php">
					<img src="images/nail-fungus.jpg" alt="nail fungus" />
				</a>
				<a href="poison-ivy.php">
					<img src="images/poison-ivy.jpg" alt="poison ivy" />
				</a>
			</div>
			<div class="text-row">
			...
			<div class="row">
				<a href="pruritus.php">
					<img src="images/pruritus.jpg" alt="pruritus" class="first" />
				</a>
				<a href="psoriasis.php">
					<img src="images/psoriasis.jpg" alt="psoriasis" />
				</a>
				<a href="rash.php">
					<img src="images/rash.jpg" alt="rash" />
				</a>
				<a href="rosacea.php">
					<img src="images/rosacea.jpg" alt="rosacea" />
				</a>
			</div>
			<div class="text-row">
			...
			<div class="row">
				<a href="scleroderma.php">
					<img src="images/scleroderma.jpg" alt="scleroderma" class="first" />
				</a>
				<a href="vitiligo.php">
					<img src="images/vitiligo.jpg" alt="vitiligo" />
				</a>
				<a href="wrinkles.php">
					<img src="images/wrinkles.jpg" alt="wrinkles" />
				</a>
			</div>
			<div class="text-row">
